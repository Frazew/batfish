...
public enum CiscoNxosStructureUsage implements StructureUsage {
  ...
  BFD_ECHO_INTERFACE("bfd echo-interface"),
  ...
  SNMP_SERVER_USE_ACL("snmp-server use-acl"),
  SNMP_SERVER_USE_IPV4ACL("snmp-server use-ipv4acl"),
  SNMP_SERVER_USE_IPV6ACL("snmp-server use-ipv6acl"),
  SNMP_SERVER_CONTEXT_VRF("snmp-server context vrf"),
